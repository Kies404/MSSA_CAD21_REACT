...
using MSSA_CAD21_REACT.git.Application.TodoItems.Commands.UpdateTodoItem;
using MSSA_CAD21_REACT.git.Application.TodoItems.Commands.UpdateTodoItemDetail;
using MSSA_CAD21_REACT.git.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace MSSA_CAD21_REACT.git.Web.Endpoints;
